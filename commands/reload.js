exports.run = (client, message, args) => {
    ...
    delete require.cache[require.resolve(`./admincommands/${commandName}.js` && `./usercommands/${commandName}.js`)];
    // We also need to delete and reload the command from the client.commands Enmap
    client.commands.delete(commandName);
    const props = require(`./admincommands/${commandName}.js` && `./usercommands/${commandName}.js`);
